Feature: As an user I want to test booking functionality for video call of topmate.io from public profile
  ...
  @regression @abroad
  Scenario: Validating the booking functionality for Webinar of topmate.io from public profile outside india
  ...
  @regression @india
  Scenario: Validating the booking functionality for Webinar of of topmate.io from public profile in india
    Given user clicks booking service
      | booking type | duration |
      | Webinar      | None     |
    When user clicks on Book Seat
